...
try {
  ...
  return (
    <div className="card w-72 mx-auto bg-white border rounded shadow hover:shadow-xl">
        ...
        <button onClick={handleSubmit} class="hover:shadow-form rounded-md bg-[#6A64F1] py-3 px-8 text-center text-base font-semibold text-white outline-none"  >Get permission</button>
        <button onClick={handlepatient1}  class="hover:shadow-form rounded-md bg-[#6A64F1] py-3 px-8 text-center text-base font-semibold text-white outline-none"  >Get</button>
            ...
            <div class="text-center mt-2 text-1xl font-medium "><b><u>{account[0]}</u></b>   details</div>
            
            <div class="text-center mt-2 text-1xl font-medium"><b>Full Name:</b>{patientInfo[0]} {patientInfo[1]}</div>
            ...
            <div class="text-center font-normal text-lg"><h3>DOB:</h3>{ patientInfo[2]}</div>
            <div class="text-center font-normal text-lg"><h3>phone :</h3> {patientInfo[3]}</div>

            <div class="px-6 text-center mt-2 font-light text-sm">
                <p>
                   <b>Description:</b> {patientInfo[4]}
                </p>
                <p>
                  <b>allergies:</b> 
                  {patientInfo[5]}
